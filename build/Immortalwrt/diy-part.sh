...
export Op_name="Immortalwrt-༄ 目目+🔸࿐"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export DNS_Settings="192.168.250.247 223.5.5.5"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
export Broadcast_Ipv4="192.168.250.255"                   # 设置 IPv4 广播(填入您的IP为启用)(填0为不作修改)
...
export amlogic_kernel="6.1.y_6.12.y"
